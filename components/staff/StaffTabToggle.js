...
import { BriefcaseIcon, CalendarIcon, DocumentTextIcon } from '@heroicons/react/24/outline';
    ...
    <div className="lg:hidden bg-white rounded-xl shadow-md overflow-hidden mb-2 border border-gray-200">
      <div className="grid grid-cols-3">
        <button 
          ...
          className={`py-3 px-2 text-sm font-medium flex items-center justify-center relative ${
            activeTab === 'bookings' 
