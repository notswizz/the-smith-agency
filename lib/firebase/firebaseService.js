...
class FirebaseService {
  ...
  async getSubcollection(parentCollection, parentId, subcollectionName) {
    try {
      ...
      console.error(`Error fetching subcollection ${subcollectionName} from ${parentCollection}/${parentId}:`, error);
      throw error;
    }
  }

  // Get client contacts subcollection
  async getClientContacts(clientId) {
    return await this.getSubcollection('clients', clientId, 'contacts');
  }

  // Get client showrooms subcollection
  async getClientShowrooms(clientId) {
    return await this.getSubcollection('clients', clientId, 'showrooms');
  }
}
